...
//
//  Created by Finn Ebeling on 06.05.24.
//
...
final class ListSnapshotTests: XCTestCase {
    ...
    func test_listWithErrorMessage() {
        ...
        assert(snapshot: sut.snapshot(for: .iPhone(style: .light, contentSizeCategory: .extraExtraExtraLarge)), named: "LIST_WITH_ERROR_MESSAGE_light_extraExtraExtraLarge")
    }
